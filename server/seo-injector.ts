...
function getPreRenderedContent(path: string, metadata: { title: string; description: string }): string {
  ...
  if (normalized === "/") {
    parts.push(`<h1>Bay Area Roofing Contractor Serving 60 Cities — Free Estimates</h1>`);
  } else {
  ...
  const companyBoilerplate = `<h3>About ROOF EXPRESS</h3><p><a href="/">ROOF EXPRESS</a> is the Bay Area's Diamond Certified roofing contractor, holding GAF Master Elite, CertainTeed Select ShingleMaster, and Owens Corning Platinum Preferred certifications. CSLB License #1072766. We serve <a href="/service-areas">60 cities</a> across San Francisco, the Peninsula, South Bay, East Bay, Marin County, and Contra Costa County. Call 650-666-5554 for a <a href="/contact">free estimate</a>. Office locations at 58 West Portal Avenue, San Francisco, CA 94127 and 3790 El Camino Real, Palo Alto, CA 94306. Open Monday through Saturday, 8 AM to 5 PM. Emergency service available 24 hours a day, 7 days a week. <a href="/financing">Financing available</a> up to $25,000 through Wisetack with $0 down.</p>
...
<p>With over 5,000 completed projects across <a href="/service-areas">60 Bay Area cities</a>, our experienced crews handle everything from simple <a href="/roof-repair">repairs</a> to complex <a href="/commercial">commercial installations</a>. We have maintained a 4.9-star rating across Google, Yelp, and Diamond Certified review platforms. Our team includes certified installers trained by GAF, CertainTeed, Owens Corning, and VELUX to ensure proper installation techniques and maximum warranty eligibility for every roofing system we install.</p>
<h3>Our Approach</h3>
...
<p>ROOF EXPRESS provides expert residential roofing services for Bay Area homeowners including asphalt shingle installation, tile roofing, metal roofing, and synthetic slate. We serve single-family homes, townhouses, condominiums, and multi-unit residential properties across <a href="/service-areas">60 Bay Area cities</a>. Our residential services cover the full lifecycle of your roof from initial installation through maintenance, <a href="/roof-repair">repair</a>, and eventual <a href="/roof-replacement">replacement</a>.</p>
...
<p>Find answers to the most common Bay Area roofing questions our customers ask about costs, timelines, materials, permits, warranties, and choosing a contractor. These answers are based on our experience with over 5,000 completed projects across <a href="/service-areas">60 Bay Area cities</a> and reflect current 2025-2026 market conditions, building codes, and best practices for the San Francisco Bay Area region.</p>
...
${companyBoilerplate}`,
    ...
    "/service-areas": `<h2>60 Bay Area Cities We Serve</h2>
<p>ROOF EXPRESS provides professional roofing services across 60 Bay Area cities organized into 7 geographic regions. Each city we serve receives the same Diamond Certified quality, manufacturer-backed installations, and local expertise that has made us the Bay Area's most trusted roofing contractor. Our two office locations in San Francisco and Palo Alto allow us to provide fast, efficient service throughout the entire region.</p>
...
<p>This page provides a complete directory of all pages on the ROOF EXPRESS website. Our site includes <a href="/services">service pages</a> describing each roofing service we offer, city coverage pages for all <a href="/service-areas">60 Bay Area cities</a> we serve, comprehensive city roofing guides with local climate, permit, and cost information, blog articles covering Bay Area roofing topics, and company information pages including our <a href="/about">story</a>, methodology, <a href="/reviews">reviews</a>, and <a href="/contact">contact details</a>. Use this directory to find any page on our site quickly.</p>
