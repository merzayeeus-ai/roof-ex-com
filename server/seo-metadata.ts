...
const staticMetadata: Record<string, { title: string; description: string }> = {
  "/": {
    ...
    description: "Diamond Certified roofing contractor serving San Francisco Bay Area. Roof repair, replacement, flat roofing, gutters & skylights. CSLB #1072766. Free estimates.",
  },
  "/about": {
  ...
  "/service-areas": {
    title: "60 Bay Area Cities We Serve — Roofing Coverage Map | ROOF EXPRESS",
    description: "ROOF EXPRESS serves 60 Bay Area cities across 7 regions. Find your city for local roofing services, free estimates, and same-day inspections.",
  },
  "/city-roofing-guides": {
...
const staticKeywords: Record<string, string> = {
  "/": "roofing contractor Bay Area, roof repair San Francisco, roof replacement, flat roofing, gutter installation, skylight repair, emergency roof repair, Diamond Certified roofer, GAF Master Elite, free roofing estimate, CSLB licensed contractor, 50-year warranty, residential roofing, commercial roofing",
  "/residential": "residential roofing Bay Area, asphalt shingle roof, tile roof installation, roof replacement home, GAF Timberline shingles, Owens Corning Duration, CertainTeed Landmark, architectural shingles, 50-year roof warranty, home roof repair, roof cost Bay Area, metal roofing residential",
  "/commercial": "commercial roofing Bay Area, TPO roof installation, flat roof commercial, modified bitumen, single-ply membrane, Title 24 cool roof, commercial roof repair, warehouse roofing, office building roof, EPDM rubber roof, built-up roofing, standing seam metal roof",
  "/flat": "flat roof repair Bay Area, TPO membrane installation, torch-down roofing, modified bitumen flat roof, silicone roof coating, ponding water fix, flat roof leak repair, low-slope roofing, cool roof coating, EPDM flat roof, flat roof replacement cost",
  "/roof-repair": "roof repair Bay Area, roof leak repair near me, emergency roof repair, same-day roof fix, shingle repair, flashing repair, chimney leak fix, storm damage roof repair, roof patch, tile roof repair, flat roof repair, gutter leak repair",
  "/roof-replacement": "roof replacement Bay Area, new roof cost, full roof tear-off, roof replacement near me, how much does a new roof cost, 50-year roof warranty, GAF Golden Pledge warranty, asphalt shingle replacement, roof replacement timeline, re-roofing Bay Area",
  "/gutters": "gutter installation Bay Area, seamless gutters, aluminum gutter, copper gutter installation, gutter repair, gutter guard installation, downspout installation, rain gutter, gutter cleaning, gutter replacement, French drain, fascia board repair",
  "/skylights": "skylight installation Bay Area, Velux skylight, skylight repair, skylight replacement, sun tunnel installation, skylight leak repair, deck mount skylight, curb mount skylight, skylight flashing kit, natural light, skylight cost",
  "/emergency": "emergency roof repair Bay Area, 24/7 roof repair, storm damage roof, roof leak emergency, emergency tarping, wind damage roof, tree damage roof, active roof leak, same-day emergency roofer, flood damage roof repair",
  "/about": "about ROOF EXPRESS, Diamond Certified roofing company, GAF Master Elite contractor, Bay Area roofer since 2017, CSLB 1072766, Owens Corning Platinum Preferred, CertainTeed Select ShingleMaster, trusted local roofer, roofing company near me",
  ...
  "/service-areas": "Bay Area roofing service areas, cities we serve, San Francisco roofer, San Jose roofer, Oakland roofer, Peninsula roofer, South Bay roofer, East Bay roofer, Marin County roofer, 60 cities roofing",
...
export function getRouteMetadata(path: string): {
  ...
  if (cityMatch && CITY_SLUGS.includes(cityMatch[1])) {
    ...
    return {
      ...
      description: `Top-rated roofing contractor in ${cityName}, CA. Residential & commercial roof repair, full roof replacement, flat roofing, gutter installation & skylight repair. Diamond Certified, GAF Master Elite, CSLB #1072766. Free estimates — call (650) 666-5554.`,
      canonical: `${SITE_CONFIG.siteUrl}${normalized}`,
      ogImage: `${SITE_CONFIG.siteUrl}${getCityImage(citySlug)}`,
      keywords: `roofing contractor ${cityName}, roof repair ${cityName} CA, roof replacement ${cityName}, roofer near me ${cityName}, ${cityName} roofing company, flat roof ${cityName}, gutter installation ${cityName}, emergency roof repair ${cityName}, Diamond Certified roofer ${cityName}, best roofer ${cityName}`,
    };
  }
  ...
  if (cityGuideMatch && CITY_SLUGS.includes(cityGuideMatch[1])) {
    ...
    return {
      title: guideTitle,
      description: `Complete ${cityName} roofing guide for 2026: local permit requirements, climate-specific material recommendations, average cost ranges, common roof problems, and seasonal maintenance tips. Your independent resource for roofing decisions in ${cityName}, CA.`,
      canonical: `${SITE_CONFIG.siteUrl}/city-roofing-guides/${citySlug}`,
      ogImage: `${SITE_CONFIG.siteUrl}${getCityImage(citySlug)}`,
      keywords: `${cityName} roofing guide, roof cost ${cityName} 2026, roofing permit ${cityName}, best roofing material ${cityName}, roof maintenance ${cityName}, ${cityName} roof problems, roof replacement cost ${cityName} CA, roofing climate ${cityName}, ${cityName} building permit roof`,
    };
  }
...
function getFullOrganization(): object {
  return {
    ...
    makesOffer: [
      ...
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Roof Repair", description: "Same-day roof leak detection and repair for shingle, flat, tile, and metal roofs. Flashing repair, storm damage restoration, and emergency patching across 60 Bay Area cities." } },
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { "@type": "Answer", text: "ROOF EXPRESS serves the entire San Francisco Bay Area including San Francisco, San Mateo County, Santa Clara County, Alameda County, Contra Costa County, and Marin County. We cover over 60 cities from San Francisco to San Jose and Marin to the Tri-Valley." },
          },
          {
            "@type": "Question",
  ...
  if (normalized === "/service-areas") {
    ...
    return [
      getFullOrganization(),
      {
        "@context": "https://schema.org",
        "@type": "CollectionPage",
        name: "ROOF EXPRESS Service Areas — 60 Bay Area Cities",
        url: `${siteUrl}/service-areas`,
        description: "ROOF EXPRESS serves 60 Bay Area cities across 7 regions with professional roofing services.",
        publisher: getOrgRef(),
        inLanguage: "en-US",
        mainEntity: {
          "@type": "ItemList",
  ...
  if (cityMatch && CITY_SLUGS.includes(cityMatch[1])) {
    ...
    return [
      ...
      },
      {
        ...
        serviceArea: { "@type": "AdministrativeArea", name: cityName },
        email: SITE_CONFIG.email,
        sameAs: [SITE_CONFIG.social.facebook, SITE_CONFIG.social.instagram, SITE_CONFIG.social.youtube, SITE_CONFIG.social.tiktok, SITE_CONFIG.social.yelp, SITE_CONFIG.manufacturerProfiles.gaf, SITE_CONFIG.manufacturerProfiles.certainteed, SITE_CONFIG.manufacturerProfiles.owensCorning, SITE_CONFIG.manufacturerProfiles.bbb, SITE_CONFIG.manufacturerProfiles.cslb],
      ...
      },
      {
        ...
        provider: getOrgRef(),
        areaServed: { "@type": "City", name: cityName },
        description: `Professional roofing contractor serving ${cityName}, California. Residential and commercial roof repair, full roof replacement with 50-year warranty, flat roofing (TPO, modified bitumen, silicone coatings), seamless gutter installation, Velux skylight repair, and 24/7 emergency service. Diamond Certified, GAF Master Elite, CSLB #1072766. Free estimates — call (650) 666-5554.`,
        hasOfferCatalog: {
          "@type": "OfferCatalog",
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { "@type": "Answer", text: `Yes, most ${cityName} roof replacements require a building permit. ROOF EXPRESS handles the entire permitting process for you, including the application, required inspections, and final sign-off. This is included in our service at no extra charge.` },
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            name: `Does ROOF EXPRESS offer emergency roof repair in ${cityName}?`,
            acceptedAnswer: { "@type": "Answer", text: `Yes! We offer 24/7 emergency roof repair services throughout ${cityName}. If you have an active leak or storm damage, call us at (650) 666-5554 for immediate assistance. We can typically have a crew on-site the same day.` },
          },
          {
            "@type": "Question",
            name: `Is ROOF EXPRESS licensed and insured in ${cityName}?`,
            acceptedAnswer: { "@type": "Answer", text: `Absolutely. ROOF EXPRESS holds California State License Board (CSLB) License #1072766 with full workers' compensation and general liability insurance. We are also GAF Master Elite certified, Diamond Certified, and an Owens Corning Platinum Preferred contractor.` },
          },
        ],
      },
      buildBreadcrumbs([
