...
export default function Skylights() {
  useSEO("Skylight Installation & Repair — Velux Certified | ROOF EXPRESS", "Velux skylight installation, repair, and replacement. Sun tunnels, deck-mount & curb-mount skylights. Leak-free flashing guaranteed.", "skylight installation Bay Area, Velux skylight, skylight repair, skylight replacement, sun tunnel installation, skylight leak repair, deck mount skylight, curb mount skylight, skylight cost");
