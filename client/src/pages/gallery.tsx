            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-3 mb-3 flex items-center justify-between">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {activePhoto.isBeforeAfter && (
                  <span className="bg-amber-500/90 text-black text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full tracking-widest inline-flex items-center gap-1">
            ...
            return (
              <>
                <div className="flex items-center justify-center gap-2 flex-wrap">
                  {p.isBeforeAfter && (
                    <span className="bg-amber-500 text-black text-[10px] font-black uppercase px-3 py-1 rounded-full tracking-widest inline-flex items-center gap-1.5">
        ...
        <div className="container mx-auto px-6 max-w-screen-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {[
              ...
              { value: "5.0", label: "Avg Rating", icon: "fa-star" },
