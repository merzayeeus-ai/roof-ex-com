...
export default function Residential() {
  useSEO("Residential Roofing — Shingle & Tile Systems | ROOF EXPRESS", "Expert residential roofing for Bay Area homes. Asphalt shingles, tile, slate — Diamond Certified installation with 50-year warranty.", "residential roofing Bay Area, asphalt shingle roof, tile roof installation, GAF Timberline shingles, Owens Corning Duration, 50-year roof warranty, home roof repair, metal roofing residential");
