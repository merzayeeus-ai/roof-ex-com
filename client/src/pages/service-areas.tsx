...
export default function ServiceAreas() {
  useSEO("60 Bay Area Cities We Serve — Roofing Coverage Map | ROOF EXPRESS", "ROOF EXPRESS serves 60 Bay Area cities across 7 regions. Find your city for local roofing services, free estimates, and same-day inspections.", "Bay Area roofing service areas, San Francisco roofer, San Jose roofer, Oakland roofer, Peninsula roofer, South Bay roofer, East Bay roofer, Marin County roofer, 60 cities roofing");
  return (
    <Layout>
      <section className="relative overflow-hidden bg-brandNavy min-h-[auto] md:min-h-[50vh] text-white pt-36 pb-20 md:pt-44 md:pb-32 lg:pt-52 lg:pb-40 px-4 flex items-center">
        <div className="absolute inset-0">
          <img src="/images/sf-aerial-ocean.webp" alt="San Francisco Bay Area aerial view" className="w-full h-full object-cover" width={1200} height={800} />
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-screen-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: "fa-bolt", title: "Rapid Local Response", text: "With crews positioned across the Bay Area, we provide same-day inspections and emergency service to all 60 cities." },
            ].map((card) => (
