...
export default function Home() {
  useSEO("Bay Area Roofing Contractor — Free Estimates | ROOF EXPRESS", "Diamond Certified roofing contractor serving San Francisco Bay Area. Roof repair, replacement, flat roofing, gutters & skylights. CSLB #1072766. Free estimates.", "roofing contractor Bay Area, roof repair San Francisco, roof replacement, flat roofing, gutter installation, skylight repair, emergency roof repair, Diamond Certified roofer, GAF Master Elite, free roofing estimate");
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-brandNavy min-h-[85vh] text-white py-34 lg:py-50 px-4 flex items-center">
        <div className="absolute inset-0">
          <picture>
            <source media="(max-width: 768px)" srcSet="/images/hero-mobile.webp" width={360} height={240} />
