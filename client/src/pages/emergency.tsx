...
export default function Emergency() {
  useSEO("Emergency Roof Repair — 24/7 Bay Area Response | ROOF EXPRESS", "24/7 emergency roof repair across the Bay Area. Storm damage, active leaks, emergency tarping. Call 650-666-5554 now.", "emergency roof repair Bay Area, 24/7 roof repair, storm damage roof, roof leak emergency, emergency tarping, wind damage roof, active roof leak, same-day emergency roofer");
   ...
   <h2 className="text-3xl md:text-5xl font-black mb-6 text-white">Active leak? Storm damage?</h2>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="bg-[#25D366] text-white px-10 py-5 rounded-2xl font-black text-lg uppercase tracking-widest hover:bg-[#128C7E] transition shadow-lg"
