...
export default function RoofReplacement() {
  useSEO("Roof Replacement — Full System, 50-Year Warranty | ROOF EXPRESS", "Roof replacement near you by Diamond Certified contractors. GAF Master Elite installation with up to 50-year manufacturer warranty.", "roof replacement near me, new roof cost, full roof tear-off, roof replacement Bay Area, 50-year roof warranty, GAF Golden Pledge warranty, asphalt shingle replacement near me, re-roofing Bay Area");
