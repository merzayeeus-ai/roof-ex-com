    ...
    <section className="py-16 bg-brandNavy" data-testid="section-before-after-showcase">
      <div className="container mx-auto px-6 max-w-screen-xl">
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur border border-white/20 text-amber-400 text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full mb-4" data-testid="badge-ba-label">
          ...
          <div className="relative z-[105] max-w-5xl w-full mx-4 flex flex-col items-center">
            ...
            <div className="mt-5 text-center">
              <div className="flex items-center justify-center gap-2">
                <span className="bg-amber-500 text-white text-[10px] font-black uppercase px-3 py-1.5 rounded-full tracking-widest inline-flex items-center gap-1.5" data-testid="badge-ba-lightbox-tag">
