        ...
        <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center bg-white/90 backdrop-blur-md rounded-full shadow-2xl border border-white/20 p-2 pl-3 md:p-3 md:pl-5 mt-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <div className="relative group py-4">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-0 w-[600px] bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <Link href="/daly-city" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Daly City
                    </Link>
                    <Link href="/san-mateo" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> San Mateo
                    </Link>
                    <Link href="/burlingame" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Burlingame
                    </Link>
                    <Link href="/redwood-city" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Redwood City
                    </Link>
                    <Link href="/palo-alto" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Palo Alto
                    </Link>
                    <Link href="/menlo-park" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                  ...
                  <div>
                    ...
                    <Link href="/san-jose" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> San Jose
                    </Link>
                    <Link href="/sunnyvale" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Sunnyvale
                    </Link>
                    <Link href="/santa-clara" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Santa Clara
                    </Link>
                    <Link href="/mountain-view" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Mountain View
                    </Link>
                    <Link href="/cupertino" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Cupertino
                    </Link>
                    <Link href="/milpitas" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Milpitas
                    </Link>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase text-slate-500 tracking-widest mb-3 border-b pb-2">
                    ...
                    <Link href="/oakland" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Oakland
                    </Link>
                    <Link href="/berkeley" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Berkeley
                    </Link>
                    <Link href="/fremont" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Fremont
                    </Link>
                    <Link href="/hayward" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Hayward
                    </Link>
                    <Link href="/walnut-creek" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> Walnut Creek
                    </Link>
                    <Link href="/san-rafael" className="block py-1.5 text-sm font-bold text-brandNavy hover:text-brandOrange hover:translate-x-1 transition">
                      <i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrange/50 mr-2"></i> San Rafael
                    </Link>
                  </div>
                </div>
        ...
        <div className="space-y-1 w-full max-w-sm mx-auto overflow-y-auto max-h-[55vh] px-6 scrollbar-thin">
          ...
          <div className="border-t border-white/10 pt-3">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm font-bold text-slate-300">
              ...
              <Link href="/daly-city" className="hover:text-white py-1"><i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrangeLight/40 text-xs mr-1"></i> Daly City</Link>
              ...
              <Link href="/san-mateo" className="hover:text-white py-1"><i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrangeLight/40 text-xs mr-1"></i> San Mateo</Link>
              <Link href="/sunnyvale" className="hover:text-white py-1"><i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrangeLight/40 text-xs mr-1"></i> Sunnyvale</Link>
              ...
              <Link href="/san-rafael" className="hover:text-white py-1"><i aria-hidden="true" className="fas fa-map-marker-alt text-brandOrangeLight/40 text-xs mr-1"></i> San Rafael</Link>
              <Link href="/service-areas" className="text-brandOrangeLight hover:text-white py-1 col-span-2 font-black" data-testid="link-mobile-all-cities"><i aria-hidden="true" className="fas fa-globe text-brandOrangeLight/60 text-xs mr-1"></i> All 63 Cities →</Link>
            </div>
          </div>
        </div>
