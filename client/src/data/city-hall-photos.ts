export const CITY_PHOTO_CAPTIONS: Record<string, string> = {
  ...
  "east-palo-alto": "East Palo Alto City Hall",
  "hillsborough": "Hillsborough Town Hall",
  "pescadero": "Pescadero Community Church",
};
...
const LANDMARK_CITIES = new Set(["kentfield", "los-altos", "los-gatos", "menlo-park", "san-carlos", "saratoga", "sausalito", "pescadero"]);
